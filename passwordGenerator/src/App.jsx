...
function App() {
  ...
  return (
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-1 pb-4 text-orange-500 bg-gray-800'>
      ...
      <div className='flex shadow rounded-lg overflow-hidden pb-4'>
        ...
        className='outline-none bg-blue-700 text-white px-3 py-0.5 cursor-pointer shrink-0'>Copy</button>
      </div>
      <div className='flex text-sm gap-x-2'>
        ...
        <div className='flex items-center gap-x-1'>
          ...
          />
          <label htmlFor="charIput">Characters</label>
        </div>
      </div>
    </div>
  )
